...
+ Utiliser n'importe quelle combinaison de blocs `variables`{:class="block3variables"},`envoyer à tous`{:class="block3events"}, et `si`{:class="block3control"}, avec les compétences que tu as déjà acquises, pour permettre à un utilisateur de répondre aux besoins d'un personnage
...
**Le simulateur de chauve-souris** : [Voir à l'intérieur](https://scratch.mit.edu/projects/723218328/editor){:target="_blank"}
<div class="scratch-preview" style="margin-left: 15px;">
  <iframe allowtransparency="true" width="485" height="402" src="https://scratch.mit.edu/projects/embed/723218328/?autostart=false" frameborder="0"></iframe>
</div>
...
Ta simulation doit :
+ Utiliser au moins une `variable`{:class="block3variables"} pour garder une trace de ce dont le sprite principal a besoin
...
+ Utiliser des blocs `si`{:class="block3control"} pour contrôler quand des choses se produisent
+ Utiliser des blocs `envoyer à tous`{:class="block3events"} pour communiquer entre d'autres sprites et le sprite principal
...
<div class="scratch-preview" style="margin-left: 15px;">
  <iframe allowtransparency="true" width="485" height="402" src="https://scratch.mit.edu/projects/embed/723218543/?autostart=false" frameborder="0"></iframe>
</div>

**Cultivateur de pastèques** : [Voir à l'intérieur](https://scratch.mit.edu/projects/723218685/editor){:target="_blank"}
<div class="scratch-preview" style="margin-left: 15px;">
  <iframe allowtransparency="true" width="485" height="402" src="https://scratch.mit.edu/projects/embed/723218685/?autostart=false" frameborder="0"></iframe>
</div>

**La machine à musique**: [Voir à l'intérieur](https://scratch.mit.edu/projects/723218846/editor){:target="_blank"}
<div class="scratch-preview" style="margin-left: 15px;">
  <iframe allowtransparency="true" width="485" height="402" src="https://scratch.mit.edu/projects/embed/723218846/?autostart=false" frameborder="0"></iframe>
</div>
...
![Projet terminé](images/bat-project.png) 
![Projet terminé](images/watermelon-project.png) 
![Projet terminé](images/music-project.png) 
![Projet terminé](images/rainbow-project.png)
